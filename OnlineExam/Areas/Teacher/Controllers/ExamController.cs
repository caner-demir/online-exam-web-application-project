...
namespace OnlineExam.Areas.Teacher.Controllers
{
    ...
    public class ExamController : Controller
    {
        ...
        public IActionResult Upsert(int? id, int? courseId)
        {
            ...
            //Check if there is a course with this Id in database.
            ...
            //After making sure user has a course with this Id, create Exam object.
            Exam exam = new Exam();
            if (id == null)
            {                
            ...
            {
                //Check if there is an exam with this Id in database.
                //And check if course has an exam with this Id.
                exam = _unitOfWork.Exam.GetFirstOrDefault(e => e.Id == id, includeProperties: "Course");
                if (exam == null || exam.CourseId != courseId)
                {
                    return NotFound();
                }
                //Check if user is owner of this exam.
